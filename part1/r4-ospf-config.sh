...
docker exec -it r4 vtysh -c 'configure terminal' -c 'router ospf' -c 'ospf router-id 4.4.4.4' -c 'network 10.0.12.0/24 area 0.0.0.0' -c 'network 10.0.13.0/24 area 0.0.0.0' -c 'exit' -c 'exit'
