...
docker exec -it r2 vtysh -c 'configure terminal' -c 'router ospf' -c 'ospf router-id 2.2.2.2' -c 'network 10.0.12.0/24 area 0.0.0.0' -c 'network 10.0.23.0/24 area 0.0.0.0' -c 'exit' -c 'exit'
