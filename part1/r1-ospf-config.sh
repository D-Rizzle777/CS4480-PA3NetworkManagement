...
docker exec -it r1 vtysh -c 'configure terminal' -c 'router ospf' -c 'ospf router-id 1.1.1.1' -c 'network 10.0.1.0/24 area 0.0.0.0' -c 'network 10.0.12.0/24 area 0.0.0.0' -c 'network 10.0.14.0/24 area 0.0.0.0' -c 'exit' -c 'exit'
