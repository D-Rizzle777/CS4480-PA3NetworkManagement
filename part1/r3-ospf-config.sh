...
docker exec -it r3 vtysh -c 'configure terminal' -c 'router ospf' -c 'ospf router-id 3.3.3.3' -c 'network 10.0.23.0/24 area 0.0.0.0' -c 'network 10.0.34.0/24 area 0.0.0.0' -c 'network 10.0.3.0/24 area 0.0.0.0' -c 'exit' -c 'exit'
