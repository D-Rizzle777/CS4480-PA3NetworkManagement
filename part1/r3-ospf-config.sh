...
docker exec -it r3 vtysh -c 'configure terminal' -c 'router ospf' -c 'ospf router-id 3.3.3.3' -c 'network 10.0.15.0/24 area 0.0.0.0' -c 'network 10.0.12.0/24 area 0.0.0.0' -c 'network 10.0.11.0/24 area 0.0.0.0' -c 'exit' -c 'exit'
